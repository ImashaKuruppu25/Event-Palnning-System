...
<div id="BHall"style="display:flex;">
		<div class="agile-ser" >
			<div class="container">
				<h3 class="w3layouts_head">Select <span>a Band</span></h3>
				<p class="w3_para">Band 1.</p>
					<div class="agile-ser-tp">
						<div class="col-md-4 w3-lft">
							<div class="w3agile_special_deals_grid_left_grid">
								<img src="images/band/b1.jpg" class="img-responsive" alt="">
							</div>
							<a href="TempUserBandSelectorController?band=band1">
						...
						<div class="col-md-4 w3-lft">
							<div class="w3agile_special_deals_grid_left_grid">
								<img src="images/band/b2.jpg" class="img-responsive" alt="">
							</div>
							<a href="TempUserBandSelectorController?band=band2">
							<h4>Catering & Food</h4></a>
							<p>Ut purus ipsum, facilisis sit amet sollicitudin eget, maximus convallis metus. Sed tristique dapibus dapibus.</p>
						</div>
						<div class="col-md-4 w3-lft">
							<div class="w3agile_special_deals_grid_left_grid">
								<img src="images/band/b3.jpg" class="img-responsive" alt="">
							</div>
							<a href="TempUserBandSelectorController?band=band3">
					...
					<div class="agile-ser-tp">
						<div class="col-md-4 w3-lft">
							<div class="w3agile_special_deals_grid_left_grid">
								<img src="images/band/b4.jpg" class="img-responsive" alt="">
							</div>
							<a href="TempUserBandSelectorController?band=band4">
							<h4>Party Locations</h4></a>
							<p>Ut purus ipsum, facilisis sit amet sollicitudin eget, maximus convallis metus. Sed tristique dapibus dapibus.</p>
						</div>
						<div class="col-md-4 w3-lft">
							...
							<a href="TempUserBandSelectorController?band=band5">
							<h4>Catering & Food</h4></a>
							<p>Ut purus ipsum, facilisis sit amet sollicitudin eget, maximus convallis metus. Sed tristique dapibus dapibus.</p>
						</div>
						<div class="col-md-4 w3-lft">
							...
							<a href="TempUserBandSelectorController?band=band6">
							<h4>Decor & Decorations</h4></a>
							<p>Ut purus ipsum, facilisis sit amet sollicitudin eget, maximus convallis metus. Sed tristique dapibus dapibus.</p>
						</div>
						<div class="clearfix"> </div>
	...
	<div style="text-align:center;">
		<a href="eventDetailsList.jsp">
			<button style="width:1000px;"class="button"><span>View List and Price</span></button>
		</a>
	</div>	
		...
		<form action="insert" method="post">
			HallID <input type="text" name="bID"><br>

...
<div id="BHall"style="display:flex;">
		<div class="agile-ser" >
			<div class="container">
				<h3 class="w3layouts_head">Select <span>a Deco</span></h3>
				<p class="w3_para">Deco 1.</p>
					<div class="agile-ser-tp">
						<div class="col-md-4 w3-lft">
							<div class="w3agile_special_deals_grid_left_grid">
								<img src="images/4.jpg" class="img-responsive" alt="">
							</div>
							<a href="TempUserDecoSelectorController?decoration=deco1">
						...
						<div class="col-md-4 w3-lft">
							...
							<a href="TempUserDecoSelectorController?decoration=deco2">
						...
						<div class="col-md-4 w3-lft">
							...
							<a href="TempUserDecoSelectorController?decoration=deco3">
					...
					<div class="agile-ser-tp">
						<div class="col-md-4 w3-lft">
							...
							<a href="TempUserDecoSelectorController?decoration=deco4">
							<h4>Party Locations</h4></a>
							<p>Ut purus ipsum, facilisis sit amet sollicitudin eget, maximus convallis metus. Sed tristique dapibus dapibus.</p>
						</div>
						<div class="col-md-4 w3-lft">
							...
							<a href="TempUserDecoSelectorController?decoration=deco5">
							<h4>Catering & Food</h4></a>
							<p>Ut purus ipsum, facilisis sit amet sollicitudin eget, maximus convallis metus. Sed tristique dapibus dapibus.</p>
						</div>
						<div class="col-md-4 w3-lft">
							...
							<a href="TempUserDecoSelectorController?decoration=deco6">
							<h4>Decor & Decorations</h4></a>
							<p>Ut purus ipsum, facilisis sit amet sollicitudin eget, maximus convallis metus. Sed tristique dapibus dapibus.</p>
						</div>
						<div class="clearfix"> </div>
	...
	<a href="menu.jsp">
		<button style="height:50px;">Back</button>
			...
			HallID <input type="text" name="dID"><br>

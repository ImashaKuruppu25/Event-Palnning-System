...
<div id="BHall"style="display:flex;">
		<div class="agile-ser" >
			<div class="container">
				<h3 class="w3layouts_head">Select <span>a Menu</span></h3>
				<p class="w3_para">Menu 1.</p>
					<div class="agile-ser-tp">
						<div class="col-md-4 w3-lft">
							<div class="w3agile_special_deals_grid_left_grid">
								<img src="images/menu/m1.jpg" class="img-responsive" alt="">
							</div>
							<a href="TempUserMenuSelectorController?menu=menu1" >
							<h4>Party Locations</h4></a>
							<p>Ut purus ipsum, facilisis sit amet sollicitudin eget, maximus convallis metus. Sed tristique dapibus dapibus.</p>
						</div>
						<div class="col-md-4 w3-lft">
							<div class="w3agile_special_deals_grid_left_grid">
								<img src="images/menu/m2.jpg" class="img-responsive" alt="">
							</div>
							<a href="TempUserMenuSelectorController?menu=menu2">
							<h4>Catering & Food</h4></a>
							<p>Ut purus ipsum, facilisis sit amet sollicitudin eget, maximus convallis metus. Sed tristique dapibus dapibus.</p>
						</div>
						<div class="col-md-4 w3-lft">
							<div class="w3agile_special_deals_grid_left_grid">
								<img src="images/menu/m3.jpg" class="img-responsive" alt="">
							</div>
							<a href="TempUserMenuSelectorController?menu=menu3">
							<h4>Decor & Decorations</h4></a>
							<p>Ut purus ipsum, facilisis sit amet sollicitudin eget, maximus convallis metus. Sed tristique dapibus dapibus.</p>
						</div>
						<div class="clearfix"> </div>
					</div>
					...
					<div class="agile-ser-tp">
						<div class="col-md-4 w3-lft">
							<div class="w3agile_special_deals_grid_left_grid">
								<img src="images/menu/m4.jpg" class="img-responsive" alt="">
							</div>
							<a href="TempUserMenuSelectorController?menu=menu4">
							<h4>Party Locations</h4></a>
							<p>Ut purus ipsum, facilisis sit amet sollicitudin eget, maximus convallis metus. Sed tristique dapibus dapibus.</p>
						</div>
						<div class="col-md-4 w3-lft">
							<div class="w3agile_special_deals_grid_left_grid">
								<img src="images/menu/m5.jpg" class="img-responsive" alt="">
							</div>
							<a href="TempUserMenuSelectorController?menu=menu5">
							<h4>Catering & Food</h4></a>
							<p>Ut purus ipsum, facilisis sit amet sollicitudin eget, maximus convallis metus. Sed tristique dapibus dapibus.</p>
						</div>
						<div class="col-md-4 w3-lft">
							<div class="w3agile_special_deals_grid_left_grid">
								<img src="images/menu/m6.jpg" class="img-responsive" alt="">
							</div>
							<a href="TempUserMenuSelectorController?menu=menu6">
							<h4>Decor & Decorations</h4></a>
							<p>Ut purus ipsum, facilisis sit amet sollicitudin eget, maximus convallis metus. Sed tristique dapibus dapibus.</p>
						</div>
						<div class="clearfix"> </div>
	...
	<a href="hall.jsp">
		<button style="height:50px;">Back</button>
	</a>		
	
	<!--<form action="insert" method="post">
			HallID <input type="text" name="mID"><br>
			<input type="submit" name="submit" value="Hall">
		</form>
		  -->
